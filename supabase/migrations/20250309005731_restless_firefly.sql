...
DROP POLICY IF EXISTS "Admin CV Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "Public Profile Picture Access" ON storage.objects;
...
DROP POLICY IF EXISTS "Admin Profile Picture Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated Signature Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "Public Agreement Access" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated Agreement Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "Public Certificate Access" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated Certificate Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "Public Attendance Sheet Access" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated Attendance Sheet Upload" ON storage.objects;
