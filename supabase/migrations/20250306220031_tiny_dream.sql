/*
  ...
  1. Tables
    - Adds training table if not exists
    - Adds training-related columns to user_profiles
    - Adds document template URLs
...
-- Drop existing policies for trainings table
DO $$ 
BEGIN
...
-- Enable RLS on trainings if not already enabled
